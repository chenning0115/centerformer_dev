...
class HSINet(nn.Module):
    ...
    def get_position_embedding(self, x, center_index):
    ...
    def encoder_block(self, x):
        ...
        pos_emb = self.get_position_embedding(x_pixel, (h//2, w//2))
        #1. reshape
        ...
        x_pixel = self.dropout(x_pixel) #TODO: 这个dropout到底加不加呢 20231024
